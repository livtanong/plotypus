...
var ScatterLayer = React.createClass({
	...
	updateChart: function updateChart() {
		this.destroyChart();
		this._chartLayer = new ScatterPoints(React.findDOMNode(this), this.props.data, this.props.xField, this.props.yField, this.props.xMin, this.props.xMax, this.props.yMin, this.props.yMax, this.props.classFunc, this.props.onClickDot, this.props.onMouseoverDot, this.props.onMouseoutDot);
	},
